...
<!-- need function to clear the form and hide it again. also need to figure out how to get house assigned to present an image and a line of text with house name -->
...
<!-- added card bootstrap and the expel button. just need to add the destructuring and figure out how to push the content to another area ("MOLDY VOLDY'S ARMY") -->
- You should also be able to expel a student after they have been sorted, which should remove their card from the student array and move them to Moldy Voldy's Army.
<!-- added filter house buttons -->
